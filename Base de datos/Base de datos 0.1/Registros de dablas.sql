...
#reportes
insert into reportes (id_reportes,Descripción,Torre,Apartamento0,Fecha,usuarios_fk) values (100,"se necesita reparacion de una tuberia",12,500,'24-1-23',1048674516);
insert into reportes (id_reportes,Descripción,Torre,Apartamento0,Fecha,usuarios_fk) values (101,"se necesita pintar una pared cerca de un apartamento",2,200,'24-2-25',1837492743);
insert into reportes (id_reportes,Descripción,Torre,Apartamento0,Fecha,usuarios_fk) values (102,"se necesita hacer mantenimiento a los baños de los residentes",4,250,'24-12-20',1836492847);
insert into reportes (id_reportes,Descripción,Torre,Apartamento0,Fecha,usuarios_fk) values (103,"se necesita realizar limpieza al píso",3,600,'24-12-21',1937492845);
insert into reportes (id_reportes,Descripción,Torre,Apartamento0,Fecha,usuarios_fk) values (104,"se necesita haer reparación a los elevadores",6,300,'24-3-11',1738484628);
#seguimiento
